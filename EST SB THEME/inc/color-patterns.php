<?php
/**
 * EstTheme: Color Patterns
 */

/**
 * Generate the CSS for the current custom color scheme.
 */
function estsbtheme_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter EstTheme default saturation level.
	 *
	 * @since EstTheme 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'estsbtheme_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.estsbtheme-front-page) .entry-title,
...
.colors-custom .estsbtheme-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.estsbtheme-front-page .panel-content .recent-posts article,
...
.colors-custom.estsbtheme-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters EstTheme custom colors CSS.
	 *
	 * @since EstTheme 1.0
	 *
	 ...
	 */
	return apply_filters( 'estsbtheme_custom_colors_css', $css, $hue, $saturation );
}
